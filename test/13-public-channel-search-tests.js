...
let n=0;
function ok(name,fn){fn();console.log('PASS '+name);n++;}
ok('channel mapping',()=>{
...
ok('public channel search options and results',async()=>{
 let seen;
...
(async()=>{console.log('RESULT '+n+'/2 passed')})().catch(e=>{console.error(e);process.exit(1)});
